...
class VentaController extends Controller
{
    ...
    public function generarVenta(Request $request)
    {
        ...
        Alert::success('¡Exito!', 'Se ha generado un venta')->showConfirmButton('Aceptar', 'rgba(79, 59, 228, 1)');
    ...
    public function eliminarMultiplesRegistros(Request $request)
    {
        ...
        if ($request->has('selected_taxes') && is_array($request->selected_taxes)) {
            ...
            Alert::success('¡Éxito!', 'Ventas eliminadas exiosamente')->showConfirmButton('Aceptar', 'rgba(79, 59, 228, 1)');
            return redirect()->route('ventas.index');
        }
