...
Route::get('/pdfMantenimiento/{id}', [PdfController::class, 'pdfMantenimiento'])->name('mantenimientos.pdf');
...
Route::post('/eliminar-productos', [ProductoController::class, 'eliminarMultiplesRegistros'])->name('eliminarMultiplesProductos');
Route::resource('mantenimientos', App\Http\Controllers\MantenimientoController::class);
Route::get('/datatableProductoMantenimiento', [MantenimientoController::class, 'datatableProductoVenta'])->name('mantenimientos.datatableProductoVenta');
Route::post('/eliminar-mantenimientos', [MantenimientoController::class, 'eliminarMultiplesRegistros'])->name('eliminarMultiplesMantenimientos');
